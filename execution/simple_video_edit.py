...
# Auphonic config — update these with your own UUIDs
AUPHONIC_PRESET_UUID = os.getenv("AUPHONIC_PRESET_UUID", "")
YOUTUBE_SERVICE_UUID = os.getenv("YOUTUBE_SERVICE_UUID", "")
...
def generate_metadata(
    ...
    if not words or not anthropic or not ANTHROPIC_API_KEY:
        return {
            "title": title,
